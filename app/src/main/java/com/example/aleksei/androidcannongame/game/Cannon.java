...
public class Cannon {
    ...
    // Нацеливание пушки с заданным углом
    ...
    // Создает ядро и стреляет в нарпавлении ствола
    public void fireCannonBall() {
        // Горизонтальная составляющая скорости ядра
        int velocityX = (int) (CannonView.CANNONBALL_SPEED_PERCENT * view.getScreenWidth() * Math.sin(barrelAngle));

        // Вертикальная составляющая скорости ядра
        ...
        // Построение ядра и размещение в стволе
